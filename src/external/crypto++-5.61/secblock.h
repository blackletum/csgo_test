...
public:
	...
	{
		// VALVE: clang requires AllocatorBase::CheckSize instead of CheckSize
...
public:
	...
	explicit SecBlock(size_type size_in=0)
		: m_size(size_in) {m_ptr = m_alloc.allocate(size_in, NULL);}
